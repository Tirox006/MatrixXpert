...
public class GaussEliminationWithPartielPivotingController {
    private Stage stage;
    private Scene scene;
    private Parent root; 
    @FXML
    ...
    private void handleRetrieveAndCalculateButton() {
        ...
        if( !Matrix.VerifySymetric(m) && (m.t.type==0 || m.t.type==5)){

               Vector productVector = Resolution.GaussPivotage(m,v);
